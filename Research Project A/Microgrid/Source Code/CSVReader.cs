...
public class CSVReader : MonoBehaviour
{
    ...
    public List<string> solar_irradiation = new List<string>();
    public List<float> energy_consumption = new List<float>();

    void Awake()
    {
        Debug.Log("Read the CSV file");
        TextAsset DataCSV = Resources.Load<TextAsset>("Data_Collection");
